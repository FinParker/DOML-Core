...
Lemma canonical_bool :
  forall Delta v,
    has_type Delta [] v tBool ->
    value v ->
    v = tTrue \/ v = tFalse.
Proof.
  intros Delta v HT HV.
...
Lemma canonical_pi :
  forall Delta v x T U,
    has_type Delta [] v (tPi x T U) ->
    value v ->
    exists e, v = tLam x T e.
Proof.
  intros Delta v x T U HT HV.
  inv HV; try solve [inv HT].
  inv HT.
...
Lemma substitution_preserves_typing :
  forall Delta Gamma x U e v T,
    has_type Delta (extend Gamma x U) e T ->
    has_type Delta Gamma v U ->
    has_type Delta Gamma (subst x v e) T.
Proof.
  (**
